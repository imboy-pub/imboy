...
COMMENT ON TABLE public.user_tag IS '用户标签记录表';
...
COMMENT ON COLUMN public.user_tag.tag_id IS '标签ID';
...
CREATE UNIQUE INDEX uk_user_tag_Scene_UserId_TagId_ObjectId ON public.user_tag(scene,user_id, tag_id, object_id);
