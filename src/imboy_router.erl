...
get_routes() ->
    ...
    AdmRoutes = [
        ...
        {"/adm/role/disable", adm_role_handler, #{action => disable}},
        {"/adm/roles/disable", adm_role_handler, #{action => disable}},
        {"/adm/role/delete", adm_role_handler, #{action => delete}},
        {"/adm/roles/delete", adm_role_handler, #{action => delete}},
