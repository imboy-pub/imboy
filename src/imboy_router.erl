...
get_routes() ->
    ...
    AdmRoutes = [
        ...
        {"/adm/admin/config/policy/bootstrap", adm_admin_handler, #{action => config_policy_bootstrap}},
        ...
        % 群组子功能 API
        {"/adm/group/vote/list", adm_group_handler, #{action => vote_list}},
        {"/adm/group/vote/detail", adm_group_handler, #{action => vote_detail}},
        {"/adm/group/vote/close", adm_group_handler, #{action => vote_close}},
        {"/adm/group/notice/list", adm_group_handler, #{action => notice_list}},
        {"/adm/group/notice/detail", adm_group_handler, #{action => notice_detail}},
        {"/adm/group/notice/delete", adm_group_handler, #{action => notice_delete}},
        {"/adm/group/tag/list", adm_group_handler, #{action => tag_list}},
        {"/adm/group/tag/delete", adm_group_handler, #{action => tag_delete}},
        {"/adm/group/category/list", adm_group_handler, #{action => category_list}},
        {"/adm/group/category/delete", adm_group_handler, #{action => category_delete}},
        {"/adm/group/file/list", adm_group_handler, #{action => file_list}},
        {"/adm/group/file/detail", adm_group_handler, #{action => file_detail}},
        {"/adm/group/file/delete", adm_group_handler, #{action => file_delete}},
        {"/adm/group/album/list", adm_group_handler, #{action => album_list}},
        {"/adm/group/album/detail", adm_group_handler, #{action => album_detail}},
        {"/adm/group/album/delete", adm_group_handler, #{action => album_delete}},
        {"/adm/group/schedule/list", adm_group_handler, #{action => schedule_list}},
        {"/adm/group/schedule/detail", adm_group_handler, #{action => schedule_detail}},
        {"/adm/group/schedule/cancel", adm_group_handler, #{action => schedule_cancel}},
        {"/adm/group/schedule/restore", adm_group_handler, #{action => schedule_restore}},
        {"/adm/group/governance_log/list", adm_group_handler, #{action => governance_log_list}},
        {"/adm/group/task/list", adm_group_handler, #{action => task_list}},
        {"/adm/group/task/detail", adm_group_handler, #{action => task_detail}},
        {"/adm/group/task/pending_review", adm_group_handler, #{action => task_pending_review}},
        {"/adm/group/task/review", adm_group_handler, #{action => task_review}},
        {"/adm/group/task/restore", adm_group_handler, #{action => task_restore}},
        {"/adm/group/task/close", adm_group_handler, #{action => task_close}},
        {"/adm/group/task/delete", adm_group_handler, #{action => task_delete}},
        % 消息管理 API
        ...
        {"/adm/channel/report/batch_resolve", adm_report_handler, #{action => channel_batch_resolve}},
