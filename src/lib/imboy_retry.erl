...
%% 示例：
%% ```
%% imboy_retry:with_retry(Fun, 3, 2000).
%% ```
...
%% 示例：
%% ```
%% imboy_retry:with_retry_and_timeout(Fun, 5000, 3).
%% ```
...
%% 示例：
%% ```
%% imboy_retry:with_retry_and_timeout(Fun, 5000, 3, 2000).
%% ```
