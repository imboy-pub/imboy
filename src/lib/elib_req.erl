...
%% 示例:
%%   elib_req:post("http://127.0.0.1:9800/test/req_post", #{type => 1, b => 2}).
%%   elib_req:post("http://127.0.0.1:9800/test/req_post", [1,2,3]).
%%   elib_req:get("http://127.0.0.1:9800/test/req_get").
