...
normalize_ts_test_() ->
    [
        ...
        ?_assertEqual(<<"2026-02-20T10:00:00+08:00">>,
    ...
    [
        ?_test(
            begin
                ...
                ?assertEqual([12, <<"%tom%">>, <<"2026-02-01T00:00:00+08:00">>, <<"2026-02-28T23:59:59+08:00">>], Params)
            end
        ),
        ?_test(
            begin
...
row_to_csv_line_test_() ->
    ?_test(
        begin
            Line = iolist_to_binary(adm_logout_apply_handler:row_to_csv_line(#{
                uid => 1,
                account => <<"tom">>,
                nickname => <<"Tom">>,
                app_vsn => <<"0.7.1">>,
