...
set_tag_success_test_() ->
    Mocks = [
        ...
        {ec_cnv, [
            {'to_integer', 1, fun(I) when is_integer(I) -> I;
                                 (B) when is_binary(B) ->
        ...
        {user_tag_relation_ds, [
            {'save_user_tag_relation', 6, fun(_Conn, _Scene, _Uid, _TagId, _ObjId, _CreatedAt) -> ok end},
    ...
    {setup,
        fun() -> setup_mecks(Mocks) end,
        fun(_) -> cleanup_mecks(Mocks) end,
        fun(_) ->
            [fun() ->
