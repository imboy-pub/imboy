...
add_c2c_reaction_succeeds_test_() ->
    ?WITH_MECKS(
        ...
        fun() ->
            {ok, Result} = msg_reaction_logic:add(
                <<"test_msg_c2c_001">>, <<"c2c">>, 999999, <<"👍"/utf8>>
            ),
...
add_c2g_reaction_succeeds_test_() ->
    ?WITH_MECKS(
        ...
        fun() ->
            {ok, Result} = msg_reaction_logic:add(
                <<"test_msg_c2g_001">>, <<"c2g">>, 999999, <<"❤️"/utf8>>
            ),
        ...
        [
            ...
            {msg_reaction_ds, [
                ...
                {'get_reaction_stats', 2, fun(_MsgId, _MsgType) ->
                    {ok, [
                        #{<<"emoji">> => <<"😄"/utf8>>, <<"count">> => 1, <<"users">> => [999999]}
                    ]}
                end}
            ]},
            {msg_s2c_ds, [
...
is_reacted_delegates_to_ds_test_() ->
    ?WITH_MECKS(
        ...
        fun() ->
            ?assertEqual(
                true,
                msg_reaction_logic:is_reacted(<<"test_msg_006">>, <<"c2c">>, 999999, <<"🔥"/utf8>>)
            )
        end
    ).
    ...
    ?WITH_MECKS(
        ...
        fun() ->
            ...
            ?assertMatch(
                ...
                msg_reaction_logic:add(<<"test_msg_007">>, <<"c2c">>, 999997, <<"👍"/utf8>>)
            )
        end
    ).
    ...
    ?WITH_MECKS(
        ...
        fun() ->
            ...
            ?assertMatch(
                ...
                msg_reaction_logic:add(<<"test_msg_008">>, <<"c2g">>, 999997, <<"👍"/utf8>>)
            )
        end
    ).
...
add_msg_not_found_test_() ->
    ?WITH_MECKS(
        ...
        fun() ->
            ?assertMatch(
                {error, msg_not_found},
                msg_reaction_logic:add(<<"non_existent_msg">>, <<"c2c">>, 999999, <<"👍"/utf8>>)
            )
        end
    ).
