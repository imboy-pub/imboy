...
ALTER TABLE public.user_device ADD COLUMN IF NOT EXISTS public_key VARCHAR(2048) DEFAULT '';
COMMENT ON COLUMN public.user_device.public_key IS '用户设备公钥';

ALTER TABLE public.group ADD COLUMN IF NOT EXISTS chat_aes_key VARCHAR(2048) DEFAULT '';
