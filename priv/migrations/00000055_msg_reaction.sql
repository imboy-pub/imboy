-- 消息表情回应表
CREATE TABLE IF NOT EXISTS msg_reaction (
...
CREATE INDEX IF NOT EXISTS idx_msg_reaction_user ON msg_reaction(user_id);
CREATE INDEX IF NOT EXISTS idx_msg_reaction_emoji ON msg_reaction(msg_id, msg_type, emoji);
