...
-- NOTE: conversation / conversation_pin / conversation_delete 的 varchar→bigint(TSID)
-- 改造已迁移至 000069_deferred_cross_table_patches.up.sql 统一执行，
-- 因为 conversation_pin(000040) / conversation_delete(000041) 在本迁移之后才创建。
