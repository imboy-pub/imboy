...
-- 2. 创建其他索引
CREATE INDEX IF NOT EXISTS i_c2g_ToId ON public.msg_c2g (to_id);
CREATE INDEX IF NOT EXISTS i_c2g_FromId ON public.msg_c2g (from_id);
CREATE INDEX IF NOT EXISTS i_c2g_MsgType ON public.msg_c2g (msg_type);
