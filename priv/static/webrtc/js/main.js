...
const wsUrl = protocol + '//' + window.location.host + '/webrtc/' + room
  // + '?toekn=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NTg0MTY1MDI0NjcsInN1YiI6InRrIiwidWlkIjoiOGRhejhhIn0.oZHSuhcnM-GvqkQaSJNOfcwMp9VXIIw1ZdrbfLy-cNk';
var socket;
...
function sendMessage(event, message, toPeer) {
  ...
  console.log('Client sending message: ', event, JSON.stringify(message), "; ");
