...
- DDD 充血模型落地现状：[docs/archive/architecture/ddd-rich-model-status.md](./docs/archive/architecture/ddd-rich-model-status.md)
...
- UTF-8 规范：[docs/reference/utf8-encoding.md](./docs/reference/utf8-encoding.md)
- 错误码：[docs/reference/error-codes.md](./docs/reference/error-codes.md)
- TSID 规范：[docs/reference/tsid-field-convention.md](./docs/reference/tsid-field-convention.md)
- API 格式：[docs/reference/api-format.md](./docs/reference/api-format.md)
