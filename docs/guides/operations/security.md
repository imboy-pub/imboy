...
> Related docs: `docs/guides/operations/deployment/deployment.md`, `config/sys.config.example`
> 分工：本文是交付/运维期的**安全基线**；逐项加固操作清单见 `docs/guides/security/security-hardening.md`。
